...
DZAI_heliTypes = ["pook_H13_civ","pook_H13_gunship_PMC","MQ9PredatorB","Pchela1T"];	
...
DZAI_banAIWeapons = ["KSVK_DZE","M24_desert_EP1","DMR","DMR_DZ","BAF_LRR_scoped"];										
...
DZAI_launcherTypes = ["RPG7V","Stinger"];	
