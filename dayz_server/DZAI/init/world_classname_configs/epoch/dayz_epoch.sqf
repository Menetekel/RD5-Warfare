...
DZAI_metalBars = [["ItemSilverBar",0.20],["ItemSilverBar10oz",0.10],["ItemGoldBar",0.04],["ItemGoldBar10oz",0.020],["ItemAmethyst",0.015],["ItemSapphire",0.01],["ItemEmerald",0.005]];
DZAI_metalBarNum = 1;		//Maximum number of metal bars to generate
