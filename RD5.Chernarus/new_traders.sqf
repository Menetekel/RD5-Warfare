// DayZ Epoch Chernarus Custom Traders by IT07
serverTraders = ["BAF_Soldier_SniperN_W","Pierce","FR_Marksman","FR_Light","CIV_EuroWoman01_EP1","Worker1","RU_Assistant","Citizen1","GER_Soldier_EP1","Citizen2_EP1","Citizen3_EP1","CIV_EuroMan02_EP1","Citizen4","USMC_Soldier_Light","Assistant","Citizen2","FR_Sykes","CIV_EuroWoman02_EP1","Worker2","Soldier_M4A3_PMC","Pilot_EP1","US_Delta_Force_Assault_EP1","US_Soldier_Officer_EP1","US_Delta_Force_Medic_EP1","FR_Rodriguez","Dr_Annie_Baker_EP1","Worker3","RU_Doctor","Citizen3"];
...
menu_Pierce = [
	[["Assault Rifle",637],["LMG",638],["Sniper",640],["Ammunition",478],["Special Weapons",693],["Special Ammo",699],["Special Explosives",694],["Special Vehicles",695]],
	[],
	"neutral"
];
/* NWA TRADER */
