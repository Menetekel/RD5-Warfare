...
switch true do {
	...
	case (_count <= 100): {_requirements = [["ItemGoldBar10oz",3]]};
	case (_count <= 200): {_requirements = [["ItemGoldBar10oz",4]]};
	case (_count <= 300): {_requirements = [["ItemGoldBar10oz",5]]};
	case (_count <= 400): {_requirements = [["ItemGoldBar10oz",6]]};
	case (_count > 400): {_requirements = [["ItemGoldBar10oz",7]]};
};
