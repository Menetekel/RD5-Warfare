...
[] spawn
{
	...
	call compile preprocessFile format ["germandayz\R3F\%1_strings_lang.sqf", R3F_ARTY_AND_LOG_CFG_langage];
	...
	{
		execVM "germandayz\R3F\surveiller_nouveaux_objets.sqf";
	}
	// Version allégée pour le serveur dédié
	else
	{
		execVM "germandayz\R3F\surveiller_nouveaux_objets_dedie.sqf";
	};
};