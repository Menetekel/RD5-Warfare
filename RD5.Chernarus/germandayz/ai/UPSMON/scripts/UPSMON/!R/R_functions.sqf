...
R_ThrowSmoke = 
	{
		...
		*/
		...
		_shell = ["SmokeShell","SmokeShellGreen","SmokeShellYellow","SmokeShellBlue","SmokeShellRed","F_40mm_White","F_40mm_Green","F_40mm_Red","F_40mm_Yellow"] call BIS_fnc_selectRandom;
