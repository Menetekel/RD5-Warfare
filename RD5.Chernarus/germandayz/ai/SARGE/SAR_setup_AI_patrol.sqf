...
for [{_i=0}, {_i < _snipers}, {_i=_i+1}] do
{
    ...
    _this setVehicleInit "null = [this] execVM 'germandayz\ai\SARGE\SAR_trace_entities.sqf';this setIdentity 'id_SAR';";
    _this addMPEventHandler ["MPkilled", {Null = _this execVM "germandayz\ai\SARGE\SAR_aikilled.sqf";}]; 
    _this addMPEventHandler ["MPHit", {Null = _this execVM "germandayz\ai\SARGE\SAR_aihit.sqf";}]; 
...
for [{_i=0}, {_i < _riflemen}, {_i=_i+1}] do
{
    ...
    _this setVehicleInit "null = [this] execVM 'germandayz\ai\SARGE\SAR_trace_entities.sqf';this setIdentity 'id_SAR_sold_man';";    
    _this addMPEventHandler ["MPkilled", {Null = _this execVM "germandayz\ai\SARGE\SAR_aikilled.sqf";}]; 
    _this addMPEventHandler ["MPHit", {Null = _this execVM "germandayz\ai\SARGE\SAR_aihit.sqf";}];     
    [_this] joinSilent _group;
...
switch (_action) do {
    ...
    case "fortify":
    {
        ...
        _ups_para_list execVM 'germandayz\ai\UPSMON\scripts\upsmon.sqf';
    };
    case "fortify2":
    {
